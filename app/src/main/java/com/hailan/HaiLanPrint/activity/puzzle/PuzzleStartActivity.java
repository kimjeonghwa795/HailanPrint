package com.hailan.HaiLanPrint.activity.puzzle;
...
import com.hailan.HaiLanPrint.activity.postcard.PostcardForIllustrationActivity;
...
import com.hailan.HaiLanPrint.databinding.ActivityPuzzleStartBinding;
import com.hailan.HaiLanPrint.databinding.ItemPuzzleChooseInchBinding;
...
public class PuzzleStartActivity extends ToolbarActivity<ActivityPuzzleStartBinding> {
    ...
    private PuzzleInchAdapter mAdapter;
    ...
    protected void initData() {
        ...
        mAdapter = new PuzzleInchAdapter();
    ...
    public void toIllutrationActivityAction(View view){
        Intent intent = new Intent(PuzzleStartActivity.this, PuzzleForIllustrationActivity.class);
    ...
    //region ADAPTER
    public class PuzzleInchAdapter extends RecyclerView.Adapter<PuzzleInchAdapter.BindingHolder> {

        @Override
        public PuzzleInchAdapter.BindingHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.item_puzzle_choose_inch, parent, false);
            PuzzleInchAdapter.BindingHolder holder = new PuzzleInchAdapter.BindingHolder(itemView);
            return holder;
        }

        @Override
        public void onBindViewHolder(PuzzleInchAdapter.BindingHolder holder, int position) {
        ...
        public class BindingHolder extends RecyclerView.ViewHolder {
            ...
            public ItemPuzzleChooseInchBinding viewDataBinding;
...
//                NavUtils.toSelectAlbumActivity(view.getContext());
                Intent intent = new Intent(PuzzleStartActivity.this, PhotoTypeActivity.class);
                startActivity(intent);
            }
        }
    }
