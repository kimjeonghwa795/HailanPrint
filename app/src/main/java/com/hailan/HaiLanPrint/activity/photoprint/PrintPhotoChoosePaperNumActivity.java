...
import com.hailan.HaiLanPrint.databinding.ActivityPrintPhotoChoosePaperNumBinding;
import com.hailan.HaiLanPrint.databinding.ItemPrintPhotoChoosePagerNumBinding;
...
//        });
    ...
    private void GetPhotoTemplateByTypeDesc(final int TypeDescID) {
        ...
        GlobalRestful.getInstance().GetPhotoTemplateByTypeDesc(TypeDescID, new Callback<ResponseData>() {
            ...
            public void onResponse(Call<ResponseData> call, Response<ResponseData> response) {
                ...
                checkButton = null;
                mDataBinding.rgPaper.removeAllViews();
    ...
    private void addButtonView(Template.PropertyListBean propertyListBean) {
        ...
        if (mDataBinding.rgPaper.getChildCount() == 0) {
        ...
        mDataBinding.rgPaper.addView(view);
    }
...
//        }
    ...
    public class PrintPhotoChoosePaperNumAdapter extends RecyclerView.Adapter<PrintPhotoChoosePaperNumAdapter.BindingHolder> {
        ...
        public BindingHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_print_photo_choose_pager_num, parent, false);
